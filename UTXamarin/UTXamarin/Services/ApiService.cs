...
using UTXamarin.Models;
using Xamarin.Essentials;

namespace UTXamarin.Services
{
    public class ApiService
    {
        public async Task<bool> RegisterUser(string email, string password, string confirmPassword)
        {
            ...
            var response = await httpClient.PostAsync("https://ubertutor.azurewebsites.net/api/Account/Register", content);
        ...
        public async Task<TokenResponse> GetToken(string email, string password)
        {
            ...
            var response = await httpClient.PostAsync("https://ubertutor.azurewebsites.net/Token", content);
        ...
        public async Task<bool> PasswordRecovery(string email)
        {
            ...
            var content = new StringContent(json, Encoding.UTF8, "application/json");
            var response = await httpClient.PostAsync("https://ubertutor.azurewebsites.net/api/Users/PasswordRecovery", content);
            return response.IsSuccessStatusCode;
        }
        ...
        public async Task<bool> ChangePassword(string oldPassword, string newPassword, string confirmPassword)
        {
            ...
            var response = await httpClient.PostAsync("https://ubertutor.azurewebsites.net/api/Account/ChangePassword", content);
            return response.IsSuccessStatusCode;
        }
        ...
        public async Task<bool> BecomeAnInstructor(Instructor instructor)
        {
            ...
            var content = new StringContent(json, Encoding.UTF8, "application/json");
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accesstoken", ""));
            var response = await httpClient.PostAsync("https://ubertutor.azurewebsites.net/api/instructors", content);
        ...
        public async Task<List<Instructor>> GetInstructors()
        {
            var httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accesstoken", ""));
            var response = await httpClient.GetStringAsync("https://ubertutor.azurewebsites.net/api/instructors");
        ...
        public async Task<Instructor> GetInstructor(int id)
        {
            var httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accesstoken", ""));
            var response = await httpClient.GetStringAsync("https://ubertutor.azurewebsites.net/api/instructors/" + id);
        ...
        public async Task<List<Instructor>> SearchInstructors(string subject, string gender, string city)
        {
            var httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accesstoken", ""));
            var response = await httpClient.GetStringAsync("https://ubertutor.azurewebsites.net/api/instructors?subject=" + subject + "&gender=" + gender + "&city=" + city);
            return JsonConvert.DeserializeObject<List<Instructor>>(response);
        }
        ...
        {
            var httpClient = new HttpClient();
            var response = await httpClient.GetStringAsync("https://ubertutor.azurewebsites.net/api/cities");
        ...
        {
            var httpClient = new HttpClient();
            var response = await httpClient.GetStringAsync("https://ubertutor.azurewebsites.net/api/courses");
